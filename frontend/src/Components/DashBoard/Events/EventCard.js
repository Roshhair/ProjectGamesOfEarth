...
export const EventCard = () => {
  return (
    <div className='eventcard_maindiv eventcard_col-3 eventcard_clearfix'>
      ...
      <div className='eventcard_color_white eventcard_div_padding eventcard_div_color eventcard_div_margin'>Football</div>
      ...
      <div className='eventcard_div_margin'>
        <ul className='eventcard_list'>
          <li className='eventcard_list_items eventcard_float_left eventcard_margin_left'><button className='eventcard_buttons'>Delete</button></li>
