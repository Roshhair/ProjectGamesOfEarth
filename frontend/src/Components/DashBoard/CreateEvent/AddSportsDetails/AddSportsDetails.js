    ...
    return (
        <>
            <div className='add_sports_details_div col-12'>
                <div className='col-6 div_red add_sports_details_float_left add_sports_details_div'>
                ...
                <div className='col-6 div_red add_sports_details_float_right add_sports_details_div '>
